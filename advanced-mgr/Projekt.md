...
| -------- | ------------------------------- | ------- | ------------------------------------------------------------ | --------- | --------- | --------- |
| 1        | Bartłomiej Królak               | alfa    | EY - Aspect based sentiment  analysis                        |           | WiP       |           |
| 2        | Michał Kiełczykowski            | alfa    | EY - Aspect  based sentiment analysis                        |           | WiP       |           |
...
| 10       | Błażej Szczepanowski            | epsilon | PKO                                                          |           | WIP       |           |
